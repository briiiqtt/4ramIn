                ...
                <div class="col-md-6 text-center text-md-right">
                    <div class="custom-pagination ml-auto">
                        ...
                        <div class="d-inline-block">
                            <a href="#" class="active" onclick="pageNumberClicked(event,this)">1</a>
                            <a href="#" onclick="pageNumberClicked(event,this)">2</a>
                            <a href="#" onclick="pageNumberClicked(event,this)">3</a>
                            <a href="#" onclick="pageNumberClicked(event,this)">4</a>
                            <a href="#" onclick="pageNumberClicked(event,this)">5</a>
                        </div>
