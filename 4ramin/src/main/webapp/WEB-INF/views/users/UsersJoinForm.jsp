					...
					<table>
						...
						<tr>
							...
							<td width="200"><input type="password" id="user_password"
								name="user_password" placeholder="비밀번호"></td>
						</tr>
						<tr>
							<th width="150">비밀번호 재입력</th>
							<td width="200"><input type="password" id="user_passwordRE"
								name="user_passwordRE" placeholder="비밀번호 재입력"></td>
						</tr>
						<tr>
							<th width="150">이 름</th>
							<td width="200"><input type="text" id="user_name" name="user_name" placeholder="이름">
							</td>
						</tr>
						<tr>
							<th width="150">연락처</th>
							<td width="200"><input type="text" id="user_phone" name="user_phone" placeholder="연락처">
							</td>
						</tr>
						<tr>
							<th width="150">Email</th>
							<td width="200"><input type="text" id="user_email" name="user_email" placeholder="Email">
							</td>
						</tr>
					</table>
				</div><br>
