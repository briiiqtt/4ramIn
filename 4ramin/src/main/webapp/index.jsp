		...
		<header class="site-navbar mt-3">
			<div class="container-fluid">
				<div class="row align-items-center">
					<div class="site-logo col-6"><a href="home.do">4RAMIN</a></div>
				...
				<div class="row align-items-center justify-content-center">
					<div class="col-md-12">
						<div class="mb-5 text-center">
							<h1 class="text-white font-weight-bold">어쩌고저쩌고 기업 검색</h1>
							<p>당신의 청춘과 노오력을 바칠 기업을 찾아보세요</p>
						</div>
						<%-- 폼 액션 jobSearchedResult.do --%>
						<form name="jobSearch" method="post" class="search-jobs-form" action="jobSearchedResult.do">
