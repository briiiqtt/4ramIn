...
public class CompanyVO {
	...
	public String getCom_imp() {
		return com_imp;
	}

	public void setCom_imp(String com_imp) {
	...
	public void setCom_man(String com_man) {
		this.com_man = com_man;
	}

	public String getCom_sal() {
		return com_sal;
	}
	...
	public String getMarked_date() {
		return marked_date;
	}

	public void setMarked_date(String marked_date) {
